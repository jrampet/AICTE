<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $id=getgeneratedId();
        $sql = "INSERT INTO volunteers (ID,Name,Number,Email) VALUES ('$id','$name','$cnumber','$email') ";
                ...
                <div class="app-sidebar sidebar-shadow">
                    ...
                    <div class="app-header__menu">
                        ...
                        <ul class="vertical-nav-menu">
                                ...
                                <li  >
                                    <a href="volunteers.php" class="mm-active">
                    ...
                    <div class="card-body"><h5 class="card-title">Volunteers</h5>
                        <form class="" method="POST" action="volunteers.php">
