...
<!--  checkout.php  [XR&CO'2014], Tue, 22 Oct 2019 11:56:17 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
                        ...
                        <div class="woocommerce-billing-fields">
                            ...
                            <div class="woocommerce-billing-fields__field-wrapper">
                                ...
                                <p class="form-row form-row-last validate-required" id="billing_town_city_field" data-priority="20">
                                    ...
                                    <input type="text" class="input-text " name="billing_town_city" id="billing_town_city" placeholder="" value="<?php echo $state;?>">
                                </p>
                                <p class="form-row form-row-last validate-required" id="billing_town_city_field" data-priority="20">
                                    <label for="billing_town_city" class="">Country<abbr class="required" title="required">*</abbr></label>
                                    <input type="text" class="input-text " name="billing_town_city" id="billing_town_city" placeholder="" value="<?php echo $country;?>">
                                </p>
