...
<form method="POST">
                            ...
                            <div class="vk-newlist-details">
                                ...
                                <div class="vk-newlist-details-newlist1  vk-book-details">
                                   ...
                                   <center> <button href="cart.php" class="cartbutton">Proceed to cart</button></center>
                    ...
                    <div class="wrapper">
                        ...
                        <div class="stats">
                            ...
                            <div class="price-add-cart">
                                ...
                                <div class="box-add">
                                    <button type="submit" class="btncart" name="acart"  value='.$prodid[$i].'>Add to cart</a button>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <!-- .box-price -->
