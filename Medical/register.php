...
{   
    ...
    $pcode=$_POST['pcode'];
		...
		$sql = "INSERT INTO users (Name,Email,Password,Contact,Address,District,State,Country,Pincode) 
        VALUES ('$name','$email','$password','$contact','$address','$city','$state','$country','$pcode') ";
...
<div class="uni-cart">
    <div id="wrapper-container" class="site-wrapper-container">
        ...
        <div id="main-content" class="site-main-content">
            ...
            <div class="wrap-input100 validate-input" data-validate="This Field is Required">
                <input class="input100" type="number" id="input" name="contact" placeholder="Contact">
            </div>
            <div class="wrap-input100 validate-input" data-validate="This Field is Required">
            ...
            <div class="wrap-input100 validate-input" data-validate="This Field is Required">
                <input class="input100" type="text" name="dist" placeholder="District">
            ...
            <div class="wrap-input100 validate-input" data-validate="This Field is Required">
                <input class="input100" type="number" id="input" name="pcode" placeholder="Pincode">
