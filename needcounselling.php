<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $time=$_POST['time'];
        $id=getTimestamp();
        $sql = "INSERT INTO counsellling (Name,Email,Contact,Date,Time) VALUES ('$name','$email','$cnumber','$date','$time')";
                ...
                <div class="app-sidebar sidebar-shadow">
                    ...
                    <div class="app-header__menu">
                        ...
                        <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="needcounselling.php" class="mm-active">
                    ...
                    <div class="card-body"><h5 class="card-title">Counselling Details</h5>
                        <form class="" method="POST" action="needcounselling.php">
                        ...
                        <div class="col-sm-10"><input name="cnumber" id="exampleCity" type="text" class="form-control"></div>
                            ...
                            <div class="position-relative row form-group"><label for="exampleCity" class="col-sm-2 col-form-label">Date for your conselling</label>
                        <div class="col-sm-10"><input name="date" id="exampleCity" type="date" class="form-control"></div>
                            </div>
                            <div class="position-relative row form-group"><label for="exampleCity" class="col-sm-2 col-form-label">Time</label>
                        <div class="col-sm-10"><input name="time" id="exampleCity" type="time" class="form-control"></div>
                            </div>
