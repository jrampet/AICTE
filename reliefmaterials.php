<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $units=$_POST['units'];
        $id=getTimestamp();
        $sql = "INSERT INTO reliefmatierials (Id,Name,Email,Number,Material,Unit) VALUES ('$id','$name','$email','$cnumber','$relief','$units') ";
                ...
                <div class="app-sidebar sidebar-shadow">
                    ...
                    <div class="app-header__menu">
                        ...
                        <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="reliefmaterials.php" class="mm-active">
                    ...
                    <div class="card-body"><h5 class="card-title">Providing Relief Matierials</h5>
                        <form class="" method="POST" action="reliefmaterials.php">
                        ...
                        <div class="col-sm-10"><input name="cnumber" id="exampleCity" type="text" class="form-control"></div>
                            ...
                            <div class="position-relative row form-group"><label for="exampleSelect" class="col-sm-2 col-form-label">Select Materials</label>
                                <div class="col-sm-10">
                                    <select name="relief" id="exampleSelect" class="form-control">
                                        <option>Select</option>
                                        <option>Milk</option>
                                        <option>Fruits</option>
                                        <option>Breakfast</option>
                                        <option>Napkins</option>
                                        <option>Breads and Biscuits</option>
                                    </select>
                                    
                                </div>
                            </div>
                            <div class="position-relative row form-group"><label for="exampleCity" class="col-sm-2 col-form-label">Units you will provide</label>
                        <div class="col-sm-10"><input name="units" id="exampleCity" type="number" class="form-control"></div>
                            </div>
