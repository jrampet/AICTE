...
var helpline={
  ...
  function getHelpline(){
      ...
      for(var i in helpline['contact_details']){
          if(helpline['contact_details'][i]["state_or_UT"]==state){
            console.log(helpline['contact_details'][i]["helpline_number"])
            $('#userinfo').html(`Helpline number: `+helpline['contact_details'][i]["helpline_number"]);
          }
      }
  }
  console.log(helpline['contact_details'][0]["helpline_number"]);